...
public class VolumeAdjusterWidget extends AudioComponentWidget {
    ...
    public VolumeAdjusterWidget(AudioComponent ac, AnchorPane parent, String name){
        ...
        volumeSlider = new Slider(0.1, 3, 1);
        this.center_.getChildren().add(volumeSlider);
        volumeSlider.setOnMouseDragged(e->handleSlider());
...
//      Changing the title and audiocomponent to reflect the new value from the slider
        int value = (int) this.volumeSlider.getValue();
        this.title.setText("Volume: " + value);
        this.audioComponent_ = new VolumeAdjuster(this.volumeSlider.getValue());
    }
}
