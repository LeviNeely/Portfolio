...
public class sineWaveWidget extends AudioComponentWidget {
    ...
    public sineWaveWidget(AudioComponent ac, AnchorPane parent, String name) {
        ...
        frequencySlider = new Slider(50, 1000, 440);
        center_.getChildren().addAll(frequencySlider);
        frequencySlider.setOnMouseDragged(e->handleSlider());
...
//      Updating the title and the audiocomponent to match what is on the slider
        int value = (int) this.frequencySlider.getValue();
        this.title.setText("Sine Wave (" + value + " Hz)");
        this.audioComponent_ = new SineWave(value);
    }
}
